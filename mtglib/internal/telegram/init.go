...
var productionV4Addresses = [][]tgAddr{
	{ // dc1
		{network: "tcp4", address: "149.154.175.53:443"},
	},
	{ // dc2
	...
	{ // dc5
		{network: "tcp4", address: "91.108.56.130:443"},
	},
}

var productionV6Addresses = [][]tgAddr{
	{ // dc1
...
var testV6Addresses = [][]tgAddr{
	{ // dc1
		{network: "tcp6", address: "[2001:b28:f23d:f001::e]:443"},
	},
	{ // dc2
		{network: "tcp6", address: "[2001:67c:4e8:f002::e]:443"},
	},
	{ // dc3
